  ...
  return (
    <>
      ...
      {cartData && cartData.length != 0 ? (
        <div>
          <Form action={handleSubmit} onReset={handleClear} className="flex">
            <div>
              {cartData.map((cartItem: ShoppingCartItemResponse) => {
                ...
                return (
                  <div key={cartItem.id}>
                    <Card className="col-span-12 flex h-auto min-h-[152px] flex-col sm:flex-row border border-black">
                      {product && cartItem.quantity != 0 ? (
                        <>
                          <div className="relative h-full w-full shrink-0 overflow-hidden rounded-2xl sm:h-[120px] sm:w-[120px]">
                            <img
                              src={
                                product.image ||
                                `data:image/png;base64,${defaultImg}`
                          ...
                          <div className="flex flex-1 flex-col sm:flex-row justify-between items-start sm:items-center">
                            <Card.Header className="gap-1">
                              ...
                              <Card.Description>
                                ...
                                <div>
                                  Colour: {cartItem.clothingItem.colour}
                                </div>
                              </Card.Description>
                            </Card.Header>
                            <Card.Footer className="flex items-center gap-3 mt-4">
